#include <GL/glut.h>
#include <cmath>  // Para funciones matemáticas como cos()
...
void display() {
    ...
    for (int i = 0; i < numPoints; ++i) {
        ...
        float r = 3 * cos(2 * theta);  // Radio en función de theta
...
void reshape(int w, int h) {
    ...
    glLoadIdentity();
    gluOrtho2D(-5, 5, -5, 5);  // Ajusta el rango de visión
...
int main(int argc, char** argv) {
    ...
    glutCreateWindow("Curva de Rosal");
